...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout-app','data' => ['title' => 'Biodata Lengkap','role' => $role]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Biodata Lengkap','role' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($role)]); ?>
        ...
        <div class="w-full space-y-4">
            ...
            <div class="bg-white p-4 lg:p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
                ...
                <div class="flex items-center gap-2 overflow-x-auto custom-scroll w-full xl:w-auto pb-1 xl:pb-0 flex-nowrap">
                    ...
                    <form id="filterFormBiodata" method="GET" action="<?php echo e(route('bk.biodata')); ?>" class="flex items-center gap-2 flex-shrink-0 flex-nowrap">
                        <div class="relative flex-shrink-0 w-32 md:w-36">
                            <select name="kelas"
                                ...
                                <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($k); ?>" <?php echo e($kelasAktif === $k ? 'selected' : ''); ?>><?php echo e($k); ?></option>
                        ...
                        <div class="relative">
                            <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari nama / NISN..."
                        ...
                        <?php if($search || $kelasAktif): ?>
                            <button type="button" onclick="window.location='<?php echo e(route('bk.biodata')); ?>'" class="bg-white border border-slate-200 hover:bg-slate-50 text-slate-500 px-3 py-1.5 rounded-lg text-[11px] font-bold transition flex items-center justify-center flex-shrink-0 h-[32px]">
                                Reset
                            </button>
                        <?php endif; ?>
                    </form>
                    ...
                    <a href="<?php echo e(route('bk.biodata.template')); ?>"
                    ...
                    <a id="btn-excel" href="<?php echo e(route('bk.biodata.excel', request()->query())); ?>"
                        ...
                        Unduh Excel<?php echo e($kelasAktif ? ' ('.$kelasAktif.')' : ''); ?>
                                    ...
                                    <td class="py-2.5 pl-5 pr-3">
                                        <div class="flex items-center gap-2">
                                            <?php if(!empty($s['gambar'])): ?>
                                                <img src="<?php echo e($staticBase); ?>/<?php echo e($s['gambar']); ?>"
                                                    class="w-7 h-7 rounded-full object-cover border border-slate-200 flex-shrink-0"
                                                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                                                <div class="w-7 h-7 rounded-full <?php echo e($color); ?> text-slate-800 items-center justify-center font-bold text-[10px] shadow-sm flex-shrink-0" style="display:none"><?php echo e($initials); ?></div>
                                            <?php else: ?>
                                                <div class="w-7 h-7 rounded-full <?php echo e($color); ?> text-slate-800 flex items-center justify-center font-bold text-[10px] shadow-sm flex-shrink-0"><?php echo e($initials); ?></div>
                                            <?php endif; ?>
                                            <div>
                                                <p class="font-bold text-slate-800 text-[11px] group-hover:text-[#2563eb] transition"><?php echo e($s['nama'] ?? '-'); ?></p>
                                                <p class="text-[9px] text-slate-400 font-mono mt-0.5"><?php echo e($s['nipd'] ?? '-'); ?> / <?php echo e($s['nisn'] ?? '-'); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-2.5 px-3">
                                        <div class="flex items-center gap-1.5">
                                            <span class="bg-blue-50 text-[#2563eb] px-1.5 py-0.5 rounded text-[9px] font-bold"><?php echo e($s['kelas'] ?? '-'); ?></span>
                                            <span class="text-[10px] <?php echo e(($s['jenis_kelamin'] ?? '') === 'L' ? 'text-blue-500' : 'text-pink-500'); ?> font-medium">
                                                <?php echo e(($s['jenis_kelamin'] ?? '') === 'L' ? 'Laki-laki' : 'Perempuan'); ?>

                                            </span>
                                        </div>
                                    </td>
                                    <td class="py-2.5 px-3 text-[10px] text-slate-600 font-medium">
                                        <?php echo e($s['tempat_lahir'] ?? '-'); ?>, <?php echo e($tgl); ?>

                                    </td>
                                    <td class="py-2.5 px-3">
                                        <p class="font-bold text-slate-700 text-[11px]"><?php echo e($s['nama_ayah'] ?? '-'); ?></p>
                                        <p class="text-[9px] text-slate-500"><?php echo e($s['pekerjaan_ayah'] ?? '-'); ?></p>
                                    </td>
                                    <td class="py-2.5 px-3">
                                        <p class="font-bold text-slate-700 text-[11px]"><?php echo e($s['nama_ibu'] ?? '-'); ?></p>
                                        <p class="text-[9px] text-slate-500"><?php echo e($s['pekerjaan_ibu'] ?? '-'); ?></p>
                                    </td>
                                    <td class="py-2.5 px-3 text-slate-400 font-bold text-[11px]">
                                        <?php if(!empty($s['nama_wali'])): ?>
                                            <p class="font-bold text-slate-700 text-[11px]"><?php echo e($s['nama_wali']); ?></p>
                                            <p class="text-[9px] text-slate-500"><?php echo e($s['pekerjaan_wali'] ?? '-'); ?></p>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-2.5 px-3">
                                        <p class="font-bold text-[#16a34a] text-[11px] tracking-wide"><?php echo e($s['no_telepon'] ?? '-'); ?></p>
                                        <p class="text-[9px] text-slate-500 mt-0.5 max-w-[120px] truncate" title="<?php echo e($s['alamat'] ?? ''); ?>"><?php echo e($s['alamat'] ?? '-'); ?></p>
                                    </td>
                                    <td class="py-2.5 pr-5 pl-3 text-right">
                                        <div class="flex justify-end gap-1">
                                            <button type="button" onclick='openEditModal(<?php echo e(json_encode($s)); ?>)'
                                            ...
                                            <button type="button" onclick="confirmDelete(<?php echo e($s['id']); ?>)"
                ...
                <?php if(!empty($pagination) && ($pagination['totalPages'] ?? 1) > 1): ?>
                    <div class="flex flex-col md:flex-row justify-between items-center p-3 lg:p-4 border-t border-slate-100 bg-white">
                        <p class="text-slate-500 text-[10px] mb-3 md:mb-0">
                            Halaman <span class="font-bold"><?php echo e($pagination['page'] ?? 1); ?></span> dari <span class="font-bold"><?php echo e($pagination['totalPages'] ?? 1); ?></span>
                            &mdash; Total <span class="font-bold"><?php echo e($pagination['total'] ?? 0); ?></span> data
                        </p>
                        <div class="flex items-center gap-1 flex-wrap justify-center">
                            
                            <?php if(($pagination['page'] ?? 1) > 1): ?>
                                <a href="<?php echo e(route('bk.biodata', array_merge(request()->query(), ['page' => $pagination['page'] - 1]))); ?>"
                            ...
                            <?php if($start > 1): ?>
                                <a href="<?php echo e(route('bk.biodata', array_merge(request()->query(), ['page' => 1]))); ?>" class="ajax-link w-7 h-7 rounded border border-slate-200 text-slate-600 hover:bg-slate-50 text-[10px] font-bold flex items-center justify-center transition">1</a>
                                <?php if($start > 2): ?>
                            ...
                            <?php for($p = $start; $p <= $end; $p++): ?>
                                <a href="<?php echo e(route('bk.biodata', array_merge(request()->query(), ['page' => $p]))); ?>"
                                   class="ajax-link w-7 h-7 rounded border text-[10px] font-bold flex items-center justify-center transition
                                   <?php echo e($p == $currentPage ? 'bg-[#2563eb] text-white border-blue-600 shadow-sm' : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'); ?>">
                                    <?php echo e($p); ?>
                            ...
                            <?php if($end < $lastPage): ?>
                                <?php if($end < $lastPage - 1): ?>
                                    <span class="text-slate-400 text-[10px] px-1">...</span>
                                <?php endif; ?>
                                <a href="<?php echo e(route('bk.biodata', array_merge(request()->query(), ['page' => $lastPage]))); ?>" class="ajax-link w-7 h-7 rounded border border-slate-200 text-slate-600 hover:bg-slate-50 text-[10px] font-bold flex items-center justify-center transition"><?php echo e($lastPage); ?></a>
                            <?php endif; ?>

                            
                            <?php if($currentPage < $lastPage): ?>
                                <a href="<?php echo e(route('bk.biodata', array_merge(request()->query(), ['page' => $currentPage + 1]))); ?>"
    ...
    <div id="modalTambah" style="display:none" class="fixed inset-0 bg-black/50 items-center justify-center z-50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl w-full max-w-4xl shadow-2xl flex flex-col max-h-[90vh] mx-4">
            ...
            <div class="p-5 overflow-y-auto custom-scroll space-y-5">
                <form id="formTambah" method="POST" action="<?php echo e(route('bk.biodata.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <select name="id_tahun_ajaran" required
                            ...
                            <?php $__currentLoopData = $tahunAjaranList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ta['id']); ?>" <?php echo e(($ta['status'] ?? '') === 'aktif' ? 'selected' : ''); ?>>
                                    <?php echo e($ta['tahun_ajaran']); ?> &mdash; Semester <?php echo e($ta['semester']); ?>

                                    <?php if(($ta['status'] ?? '') === 'aktif'): ?> &bull; Aktif <?php endif; ?>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
    ...
    <div id="modalImport" style="display:none" class="fixed inset-0 bg-black/50 items-center justify-center z-50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl w-full max-w-sm shadow-2xl p-5 mx-4">
            ...
            <form method="POST" action="<?php echo e(route('bk.biodata.import')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
    ...
    <form id="deleteForm" method="POST" action="" class="hidden"><?php echo csrf_field(); ?></form>

    <?php $__env->startPush('scripts'); ?>
    <script>
        const staticBase = "<?php echo e(rtrim(preg_replace('#/api$#', '', env('API_BASE_URL')), '/')); ?>";
        ...
        <?php if(session('success')): ?>
            Swal.fire({ icon: 'success', title: 'Berhasil!', text: <?php echo json_encode(session('success')); ?>, showConfirmButton: false, timer: 2000 });
        <?php endif; ?>
        <?php if(session('error')): ?>
            Swal.fire({ icon: 'error', title: 'Gagal!', text: <?php echo json_encode(session('error')); ?>, confirmButtonColor: '#ef4444' });
        <?php endif; ?>
        <?php if($errors->any()): ?>
            Swal.fire({
                icon: 'error', title: 'Peringatan Validasi!',
                html: `<div class="text-left text-[11px] text-red-600 mt-2"><ul class="list-disc pl-5"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($error); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul></div>`,
                confirmButtonColor: '#ef4444',
            });
        <?php endif; ?>
    </script>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\New foldersssss\ekesiswaan\resources\views/guru_bk/biodata.blade.php ENDPATH**/ ?>