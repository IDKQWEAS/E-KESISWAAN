...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout-app','data' => ['title' => 'Approval Perizinan','role' => $role]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Approval Perizinan','role' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($role)]); ?>
        ...
        <div class="w-full space-y-4">
            <div class="bg-white p-4 lg:p-5 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-5">
                    ...
                    <form id="filterFormIzin" method="GET" action="<?php echo e(route('bk.perizinan')); ?>"
                        ...
                        <?php if(request('kelas') || request('tanggal')): ?>
                            <button type="button" onclick="window.location='<?php echo e(route('bk.perizinan')); ?>'"
                    ...
                    <div class="overflow-x-auto custom-scroll">
                        <table class="w-full text-left text-sm whitespace-nowrap min-w-max">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <?php $__empty_1 = true; $__currentLoopData = $perizinan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $izin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php
                                    ...
                                    <tr class="hover:bg-slate-50 transition group">
                                        <td class="py-3 pl-5 pr-3 text-[11px] text-slate-500 font-mono"><?php echo e($tgl); ?></td>
                                        <td class="py-3 px-3 font-bold text-slate-800 text-[12px] group-hover:text-[#2563eb] transition">
                                            <?php echo e($izin['nama_siswa'] ?? '-'); ?>

                                            <span class="text-slate-400 font-normal text-[10px] ml-1">(<?php echo e($izin['kelas'] ?? '-'); ?>)</span>
                                        </td>
                                        <td class="py-3 px-3">
                                            <span class="<?php echo e($statusLabel['bg']); ?> <?php echo e($statusLabel['text']); ?> px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider inline-block">
                                        ...
                                        <td class="py-3 px-3">
                                            <?php if($jamMulai && $jamSelesai): ?>
                                                <div class="inline-flex items-center gap-1.5 bg-indigo-50 text-indigo-700 px-2 py-1 rounded text-[10px] font-bold">
                                                    Jam ke-<?php echo e($jamMulai); ?>

                                                    <span class="text-indigo-300 font-light mx-0.5">s/d</span>
                                                    Jam ke-<?php echo e($jamSelesai); ?>
                                        ...
                                        <td class="py-3 px-3 text-[11px] text-slate-600 max-w-[150px] truncate"><?php echo e($izin['keterangan'] ?? '-'); ?></td>
                                        <td class="py-3 px-3">
                                            <?php if(!empty($izin['gambar'])): ?>
                                                <button type="button" onclick='openEditModal(<?php echo e(json_encode($izin)); ?>, "<?php echo e($tglEdit); ?>")'
                                        ...
                                        <td class="py-3 pr-5 pl-3 text-right">
                                            <div class="flex justify-end gap-1.5">
                                                <button type="button"
                                                    onclick='openEditModal(<?php echo e(json_encode($izin)); ?>, "<?php echo e($tglEdit); ?>")'
                                                ...
                                                <button type="button"
                                                    onclick="confirmDelete(<?php echo e($izin['id']); ?>)"
    ...
    <div id="modalAddIzin" style="display:none" class="fixed inset-0 bg-black/50 items-center justify-center z-50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl p-5 lg:p-6 mx-4 max-h-[90vh] overflow-y-auto custom-scroll">
            ...
            <form method="POST" action="<?php echo e(route('bk.perizinan.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="jam_mulai" required
                                        ...
                                        <?php for($i = 1; $i <= 10; $i++): ?>
                                            <option value="<?php echo e($i); ?>">Jam ke-<?php echo e($i); ?></option>
                                        <?php endfor; ?>
                                    </select>
                                    <i class="fa-solid fa-chevron-down absolute right-3 top-1/2 -translate-y-1/2 text-[9px] text-slate-400 pointer-events-none"></i>
                                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\New foldersssss\ekesiswaan\resources\views/guru_bk/perizinan.blade.php ENDPATH**/ ?>