...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout-app','data' => ['title' => 'Manajemen User','role' => 'admin']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Manajemen User','role' => 'admin']); ?>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <p class="text-slate-500 text-xs mt-1 font-medium">
                        Kelola akun Kepala Sekolah, Guru BK, Petugas Absensi, dan Administrator. (Total: <?php echo e(count($dataUser)); ?> Akun)
                    </p>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <?php $__empty_1 = true; $__currentLoopData = $dataUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="hover:bg-slate-50 transition group h-14">
                                    <td class="py-4 pl-6 pr-4">
                                        <span class="text-sm font-bold text-slate-800 uppercase"><?php echo e($user['nama'] ?? 'Tanpa Nama'); ?></span>
                                    </td>
                                    <td class="py-4 px-4">
                                        <span class="text-xs font-bold text-slate-500 font-mono tracking-tight"><?php echo e($user['username'] ?? ($user['nip'] ?? '-')); ?></span>
                                    </td>
                                    <td class="py-4 px-4 text-center">
                                        <span class="<?php echo e($badgeClass); ?> px-3 py-1 rounded-lg text-[9px] font-black border uppercase tracking-wider inline-block">
                                            <?php echo e($roleText); ?>
                                    ...
                                    <td class="py-4 pr-6 pl-4 text-right">
                                        <div class="flex justify-end gap-3">
                                            <button type="button" onclick="openEditModal(this)" data-user='<?php echo json_encode($user); ?>' class="text-slate-400 hover:text-blue-600 transition text-base" title="Edit">
                                                <i class="fa-regular fa-pen-to-square"></i>
                                            </button>
                                            <button type="button" data-id="<?php echo e($user['id']); ?>" onclick="hapusUser(this.getAttribute('data-id'))" class="text-slate-400 hover:text-red-600 transition text-base" title="Hapus">
...
<?php endif; ?><?php /**PATH C:\laragon\www\New foldersssss\ekesiswaan\resources\views/admin/users.blade.php ENDPATH**/ ?>